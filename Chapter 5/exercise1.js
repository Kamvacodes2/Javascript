...
// prompt until the user guesses correctly. In this way we use the loop to ke
...
while (!statusRight) {
    let userGuess = prompt("Enter a number between 1 - 5 ");
    userGuess = parseInt(userGuess)

    if (userGuess === randomNumber) {
        alert('You guessed correctly it was '+ userGuess);
        statusRight = true;
